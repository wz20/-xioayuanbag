...
Page({
    ...
    submit:function(e){
      let that=this
      console.log('e',e)
      if(e.detail.value.title!==""&&e.detail.value.money!==""&&e.detail.value.about!==""&&e.detail.value.kind!==""&&e.detail.value.way!==""&&e.detail.value.place!==""&&that.data.img.length!==0){
